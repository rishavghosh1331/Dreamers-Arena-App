...
class anjali : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button2.setOnClickListener {
            val intent = Intent(this, sweta::class.java)
            startActivity(intent)
        }

        val button3 = findViewById<Button>(R.id.button10)
        button3.setOnClickListener {
            var intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/1EOFzzTigHMEyb3k5_ROBZ4mQiQ3EU-c3/view?usp=sharing"))
            startActivity(intent)
        }
    }
}